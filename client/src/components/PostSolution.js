...
const PostSolution = ({ postSolutions, isAuthenticated, match, setAlert }) => {
  ...
  const onSubmit = (e) => {
    ...
    if (!isAuthenticated) {
      setAlert("You need to login to post a solution!", "danger");
    }
  ...
  return (
    <Fragment>
      <div className="container-idea">
        <h1 className="large col-md-5 offset-1">Post your Solution</h1>
...
export default connect(mapStateToProps, { postSolutions, setAlert })(
  PostSolution
);
